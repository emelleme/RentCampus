    	...
    	<div id="mainLeft">
		    ...
		    <div class="page-content">
                ...
                <table width="500" border="0" cellspacing="4" cellpadding="3">
                  ...
                  <tr>
                    <td>Email:</td>
                    <td><input type="text" name="email" id="email" style="width:300px" value="" /></td>
                  </tr>
                  <tr>
                    <td>Phone:</td>
                    <td><input type="text" name="phone" id="phone" style="width:300px" value="" /></td>
                  </tr>
                  <tr>
                    <td>Address:</td>
                    <td><input type="text" name="address" id="address" style="width:300px" value="" /></td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      ...
                      <input type="text" name="zip" id="zip" size="5" value="" />
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2"><hr color="#CCCCCC" width="480" align="left" size="1" /></td>
                  </tr>
                  <tr>
                    <td colspan="2">Comment/Question:</td>
                  </tr>
                  <tr>
                    <td colspan="2"><textarea name="comments" id="comments" cols="45" rows="5" style="width:420px"></textarea></td>
                  </tr>
                  <tr>
                    <td colspan="2"><hr color="#CCCCCC" width="480" align="left" size="1" /></td>
                  </tr>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td><input type="submit" name="proccontact" id="proccontact" value="Submit" /></td>
                  </tr>
                </table>
				</form>
		    </div>
