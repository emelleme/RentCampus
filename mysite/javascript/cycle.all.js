...
/*Cycle Initialization for Banner Cycle*/
	$('#cycleMain').cycle({
        fx:      'fade',
		cleartype:     1,
		prev:    '#prev',
	...
	$('#cycleMain').mouseover(function() { 
		$('#cycleMain').cycle('pause'); 
	});
	$('#cycleMain').mouseout(function() { 
		$('#cycleMain').cycle('resume'); 
	});
/*End Banner Cycle*/

/*Cycle Initialization for Twitter Cycle
	$('#tweets').cycle({
		fx: 'fade',
		speedIn: 1000,
		speedOut: 1500,
